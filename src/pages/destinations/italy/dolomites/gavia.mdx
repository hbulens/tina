...
title: Passo de Gavia
cover: 
  img: 'dolomites/gavia'
  position: 0% 85%;
route: 'dolomites/dolomites-gavia'
stats:
  distance: 83
  elevation: 1200
  maxAltitude: 600
...
The latter is subject of the [El Torcal route](/destinations/spain/malaga/torcal). A second monster also leaves from Villanuvea, the **Puerto del Barco** with its fearsome 11% average for over 2 kilometers.
...
In Villanueva de La Concepción, as mentioned earlier, you have about three options: climb [El Torcal](/destinations/spain/malaga/torcal) (or the alternative ascent via La Joya), climb the Puerto del Barco, or to Arroyo Coche. 
