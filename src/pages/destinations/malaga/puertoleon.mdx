...
The route is essentially going up and down the **Puerto del Léon**. This loop of 46 km starts in Málaga to summit the Puerto del Léon, and loops back to Málaga via Olías and the coast road.
It's a short but punchy ride and extremely enjoyable with pleasant views of the Montes de Málaga, Málaga city, and the Mijas mountain range in the distance.

&nbsp;

The Puerto del Léon is a climb that has a bit of everything: it's got steep bits, it's got relatively flat sections and even a tiny bit of descent before you tackle the last 2 hard kilometers. There are hairpin corners and even
two tiny tunnels halfway up the climb. And with 16km in length at an average of 5.6%, this makes the Puerto del Léon a favorite amongst the locals. Not to mention that the climb starts in the city center. 
 
&nbsp;

However, don't be fooled by the statistics: 16km at 5.6% on average hardly sounds like a tough challenge. 
The difficulty of the climb, as is with many Spanish climbs, is that you can never find a rythm due to the constants changes in the gradient. Needless to say, the heat (and the wind during winter) often doesn't help the cause either, even though this climb offers some protection from the elements.
