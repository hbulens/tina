...
This route follows a similar pattern as the [El Torcal](/the-average-cyclist/destinations/malaga/torcal) route.
...
The route's pretty simple: you go to up Villanueva de la Concepción via [Almogía](/the-average-cyclist/destinations/malaga/almogia), go up via La Joya, go around the mountain, descend back into Villanueva de la Concepción and take the same road back home.
...
<img
  src="/the-average-cyclist/routes/lajoya/climb.png"
  alt="La Joya."
  class="mt-4 mb-8"
  height={200}
  width={750}
...
<img
  src="/the-average-cyclist/routes/lajoya/torcal-via-antequera.png"
  alt=""
  class="mt-4 mb-8"
  height={200}
  width={750}
