...
At the roundabout is where you should start getting ready for 14 epic kilometers towards the **Lagos de Covadonga**.
...
The northwest of the country is scarcely populated, but it is well connected and the villages have supermarkets and petrol stations.
For the 50km, you shouldn't have to worry about provisions. However, when you go inland towards the mountains, there's nothing so make sure you have supplies with you.

&nbsp;

At the summit of the Lagos de Covadonga, there is a restaurant.
Being the only restaurant on such a popular touristic destination, this place can be busy.
